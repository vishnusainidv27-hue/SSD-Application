...
/// Entry point for SSD Farm — Admin.
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Run `flutterfire configure` in the Admin app folder, '
...
/// Decides between the login screen and the Admin home based on the persisted
/// Firebase session and the user's role.
...
class _AuthGateState extends State<_AuthGate> {
  ...
  Future<void> _restoreSession() async {
    ...
    try {
      ...
      isAdmin = role == _adminRole;
      if (role != null && !isAdmin) {
        // Signed in as a non-admin: this app is Admin-only, so end that session.
  ...
  Future<void> _handleLoginSuccess(String role) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('This app is for Admin accounts only.')),
    );
  }
